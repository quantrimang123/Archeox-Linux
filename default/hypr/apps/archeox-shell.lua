...
hl.layer_rule({ match = { namespace = "archeox-bar" }, no_anim = true, animation = "none" })
...
hl.layer_rule({ match = { namespace = "^(archeox-menu|archeox-image-selector|archeox-emojis|archeox-clipboard|archeox-keyboard-panel)$" }, no_anim = true, animation = "none" })

...
o.bind("SUPER + CTRL + E", "Emojis", "archeox-shell shell toggle archeox.emojis")
...
o.bind("SUPER + CTRL + A", "Audio", "archeox-shell shell toggle archeox.audio")
o.bind("SUPER + CTRL + B", "Bluetooth", "archeox-shell shell toggle archeox.bluetooth")
o.bind("SUPER + CTRL + D", "Display", "archeox-shell shell toggle archeox.monitor")
o.bind("SUPER + CTRL + ALT + D", "Calendar", "archeox-shell shell toggle archeox.clock")
o.bind("SUPER + CTRL + W", "Network", "archeox-shell shell toggle archeox.network")
o.bind("SUPER + CTRL + P", "Power", "archeox-shell shell toggle archeox.power")

...
rm -rf ~/.local/share/archeox/
git clone --branch "$OMARCHY_REF" "https://github.com/${OMARCHY_REPO}.git" ~/.local/share/archeox >/dev/null

echo -e "\nInstallation starting..."
source ~/.local/share/archeox/install.sh

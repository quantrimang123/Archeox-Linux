...
EOF
  ...
  sudo cp $ILV_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $ILV_PATH/default/limine/limine.conf /boot/limine.conf
  ...
  sudo cp $ILV_PATH/default/snapper/root /etc/snapper/configs/root
